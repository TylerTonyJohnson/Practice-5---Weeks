...
function addWeek(i) {
  ...
  //   //   Array.from(document.getElementsByClassName("highlight-boundary")).forEach(
  //   //     (item) => {
  ...
  //   hoverLabel.update(
  //     event.pageY - hoverLabelOffset,
  //     event.pageX + hoverLabelOffset,
  //     rootDate ? "HI" : event.target.firstChild.id
  //   );
  // };
